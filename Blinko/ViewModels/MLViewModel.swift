...
class MLViewModel {
    ...
    private func loadMLModel() {
        ...
        if let compiledModelURL = Bundle.main.url(forResource: "SchoolObjects", withExtension: "mlmodelc") {
            do {
        ...
        guard let modelURL = Bundle.main.url(forResource: "SchoolObjects", withExtension: "mlmodel") else {
